...
public class GPUImageTwoInputFilter extends GPUImageFilter {
    ...
    public GPUImageTwoInputFilter(String fragmentShader, boolean flipVertical) {
        this(VERTEX_SHADER, fragmentShader, flipVertical);
    }

    public GPUImageTwoInputFilter(String vertexShader, String fragmentShader, boolean flipVertical) {
        super(vertexShader, fragmentShader);
        mTexture2CoordinatesBuffer = setRotation(Rotation.NORMAL, false, flipVertical);
    }
    ...
    protected ByteBuffer setRotation(final Rotation rotation, final boolean flipHorizontal, final boolean flipVertical) {
